...
<div class="inner-wrapper">
  ...
  <div class="options-wrapper">
    <div class="split left">
      ...
      <a href="index.php?p=hock_train_y&s=off" class="btn"><?php echo $lang['read_more']; ?></a>
    </div>
    <div class="split middle">
      <h3><?php echo $lang['junior']; ?></h3>
      <a href="index.php?p=hock_train_j&s=off" class="btn"><?php echo $lang['read_more']; ?></a>
    </div>
    <div class="split right">
      <h3><?php echo $lang['pro']; ?></h3>
      <a href="index.php?p=hock_train_p&s=off" class="btn"><?php echo $lang['read_more']; ?></a>
    </div>
  </div>

  <div class="info-offseason">
    <?php echo $lang['offseason_info']; ?>
  </div>

  <div class="training-quote">
    <!-- <img src="images/quote_img.jpg" alt=""> -->
    <p><?php echo $lang['inspirational_quote4']; ?></p>
  </div>
