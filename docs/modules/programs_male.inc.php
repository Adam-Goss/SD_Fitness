<?php # programs_male.inc.php
/* this page is the male program content module (male training programs)
...
<div class="inner-wrapper">
  ...
  <div class="programs-wrapper">
    ...
    $q = 'SELECT id, title, short_description, img_file_name FROM products WHERE gender = "male" AND age_group = "all" AND volume=1';
