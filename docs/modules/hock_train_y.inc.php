<?php # hock_train_y.inc.php
/* this page is the hockey training youth content module (youth hockey
* training programs)
...
<div class="inner-wrapper">
  ...
  <h2><?php echo $lang['youth'] .' '. $season .' '. $lang['training_programs']; ?></h2>
  </div>
  ...
  <div class="programs-wrapper">
    ...
    if($num > 0) { //query ran OK
      ...
      echo '<p class="error">' . $lang['no_youth_programs'] . '</p>';
    }
    ?>
